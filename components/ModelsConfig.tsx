  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Field label={t("Provider name")}>
        <TextInput value={editingName} onChange={setEditingName} placeholder={t("provider-name")} mono />
      ...
      <Field label={t("Base URL")}>
        <TextInput value={provider.baseUrl ?? ""} onChange={(v) => set("baseUrl", v || undefined)}
          placeholder={t("https://api.example.com/v1")} mono />
      </Field>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        ...
        <Field label="Name"><TextInput value={model.name ?? ""} onChange={(v) => set("name", v || undefined)} placeholder={t("Display name")} /></Field>
      </div>
      ...
      <div style={{ minHeight: 48 }}>
        {loginState.phase === "idle" && (
          <p style={{ margin: 0, fontSize: 12, color: "var(--text-muted)", lineHeight: 1.5 }}>
            {provider.loggedIn ? t("Already connected. You can re-login or disconnect.") : `连接到 ${provider.name} 账户。`}
          </p>
        )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {loginState.phase === "auth" && (
              <p style={{ margin: 0, fontSize: 11, color: "var(--text-dim)", lineHeight: 1.5 }}>
                {t("If the browser window did not open,")}{" "}
      ...
      <Field label={t("API Key")}>
        <div style={{ display: "flex", gap: 6 }}>
          <SecretTextInput
            ...
            placeholder={provider.configured ? t("Enter new key to replace…") : t("sk-…")}
            style={{ flex: 1 }}
            autoComplete="off"
            spellCheck={false}
            mono

...
const PRESETS: { id: ToolPreset; label: string; desc: string; tools: string[] }[] = [
  { id: "none",    label: t("Off"),  desc: t("No tools"),                                tools: PRESET_NONE },
  { id: "default", label: t("Low"),  desc: t("read · bash · edit · write"),              tools: PRESET_DEFAULT },
  { id: "full",    label: t("High"), desc: t("read · bash · edit · write · grep · find · ls"), tools: PRESET_FULL },
];
